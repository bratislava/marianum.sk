...
import type { partitionCemeteries } from './application.utils'
...
export namespace ApplicationTypes {
  ...
  export type StepComponentProps<T extends Step> = {
    values?: DeepPartial<StepModelMap[T]>
    onContinue: (values: StepModelMap[T]) => void
    onFormChange: (values: DeepPartial<StepModelMap[T]>) => void
  }

  export type Cemeteries = ReturnType<typeof partitionCemeteries>
}
