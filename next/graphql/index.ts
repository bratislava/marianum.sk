...
export type GenericMorph =
  ...
  | ComponentSectionsReviewsSection
...
export type BranchEntityFragment = {
  ...
  attributes?: {
    ...
    slug: string
    type: Enum_Branch_Type
    cemeteryType?: Enum_Branch_Cemeterytype | null
    description?: string | null
    address?: string | null
    navigateToLink?: string | null
...
export type PageEntityFragment = {
  ...
  attributes?: {
    ...
    sections?: Array<
      ...
      | { __typename: 'ComponentSectionsNewsListing'; id: string; title?: string | null }
      | {
          __typename: 'ComponentSectionsPartnersSection'
          id: string
          featuredPartnersTitle: string
...
export type FlatNavigationItemFragment = {
  ...
  related?: {
    ...
    id: number
    attributes?:
      | { __typename: 'Branch'; title: string; slug: string }
...
export type ArticlesStaticPathsQuery = {
  ...
  articles?: {
    ...
    data: Array<{
      __typename?: 'ArticleEntity'
      id?: string | null
      attributes?: { __typename?: 'Article'; slug: string; locale?: string | null } | null
    }>
  } | null
}
...
export type BundlesStaticPathsQuery = {
  ...
  bundles?: {
    ...
    data: Array<{
      __typename?: 'BundleEntity'
      id?: string | null
      attributes?: { __typename?: 'Bundle'; slug: string; locale?: string | null } | null
    }>
  } | null
}
...
export type DocumentsStaticPathsQuery = {
  ...
  documents?: {
    ...
    data: Array<{
      __typename?: 'DocumentEntity'
      id?: string | null
      attributes?: { __typename?: 'Document'; slug?: string | null } | null
    }>
  } | null
}
    ...
    data?: {
      ...
      attributes?: {
        ...
        sections?: Array<
          ...
          | { __typename: 'ComponentSectionsReviewsSection'; id: string; title?: string | null }
          | { __typename?: 'Error' }
          | null
        > | null
      } | null
...
export const CemeteriesDocument = gql`
  query Cemeteries($locale: I18NLocaleCode!) {
    branches(locale: $locale, filters: { type: { eq: "cintorin" } }, sort: ["title:asc"]) {
      data {
        ...BranchEntity
      }
    }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    Procedures(
      ...
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<ProceduresQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProceduresQuery>(ProceduresDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Procedures',
    ...
    Partners(
      ...
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<PartnersQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PartnersQuery>(PartnersDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Partners',
    ...
    News(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<NewsQuery>(NewsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'News',
    ...
    Cemeteries(
      variables: CemeteriesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<CemeteriesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CemeteriesQuery>(CemeteriesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Cemeteries',
    ...
    BundleBySlug(
      variables: BundleBySlugQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<BundleBySlugQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BundleBySlugQuery>(BundleBySlugDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'BundleBySlug',
    ...
    BranchesStaticPaths(
      variables?: BranchesStaticPathsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<BranchesStaticPathsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BranchesStaticPathsQuery>(BranchesStaticPathsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'BranchesStaticPaths',
    ...
    BundlesStaticPaths(
      variables?: BundlesStaticPathsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<BundlesStaticPathsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BundlesStaticPathsQuery>(BundlesStaticPathsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'BundlesStaticPaths',
    ...
    HomepageCeremonies(
      variables: HomepageCeremoniesQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<HomepageCeremoniesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<HomepageCeremoniesQuery>(HomepageCeremoniesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'HomepageCeremonies',
